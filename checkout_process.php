...
*/
  ...
  if (!empty($_REQUEST['Ds_MerchantData']))  {
  	$_REQUEST['osCsid']=$_REQUEST['Ds_MerchantData'];
  }
...
//------insert customer choosen option eof ----
    ...
    /**********************************************************
  Parraingage :
  On désactive les filleuls pour que le client n'utilise pas une nouvelle fois ces avantages
  ***********************************************************/
  if (defined('MODULE_ORDER_TOTAL_SPONSORSHIP_STATUS') && MODULE_ORDER_TOTAL_SPONSORSHIP_STATUS == 'true') {
    if ( isset($_SESSION['sponsorship']) && is_array($_SESSION['sponsorship']) ) {
	  // On récupère le nombre de réduction utilisé
