<?php
    ...
    define('FILENAME_ALLMANUFACTURERS', 'allmanufacturers.php');
    ...
    define('FILENAME_ACCOUNT_SPONSORSHIP', 'account_sponsorship.php');
    ...
    define('FILENAME_ACCOUNT_DELETE_PROCESS', 'account_delete_process.php');
    define('FILENAME_ACCOUNT_DELETE_SUCCESS', 'account_delete_success.php');
    ...
    define('FILENAME_CHECKOUT_ONEPAGE', 'checkout.php');
