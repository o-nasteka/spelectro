...
*/
  ...
  define('MODULE_PAYMENT_TRANSFERENCIA_TEXT_TITLE', 'Ingreso o Transferência bancária');
  define('MODULE_PAYMENT_TRANSFERENCIA_TEXT_DESCRIPTION', 'Ingreso o Transferência bancária');
