<?php
/*
  $Id: transferencia2.php, 10/16/2004
...
*/
  ...
  define('MODULE_PAYMENT_TRANSFERENCIA2_TEXT_TITLE', 'Transferência Bancária');
  define('MODULE_PAYMENT_TRANSFERENCIA2_TEXT_DESCRIPTION', 'Transferência Bancária');
