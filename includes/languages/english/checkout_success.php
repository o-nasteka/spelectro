...
define('TEXT_SUCCESS', 'Your order has been successfully processed! Your products should arrive within 2-5 working days max.');
...
define('TEXT_THANKS_FOR_SHOPPING', ' Thanks for shopping with us!');
