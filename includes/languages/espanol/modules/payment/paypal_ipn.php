...
*/
  ...
  define('MODULE_PAYMENT_PAYPAL_IPN_TEXT_TITLE', 'Pago via Paypal');
  define('MODULE_PAYMENT_PAYPAL_IPN_TEXT_DESCRIPTION', 'PayPal IPN v2.3.3');
  // BOF add by AlexStudio
  define('MODULE_PAYMENT_PAYPAL_IPN_TEXT_SELECTION', 'PayPal');
  define('MODULE_PAYMENT_PAYPAL_IPN_TEXT_LAST_CONFIRM', 'PayPal');
