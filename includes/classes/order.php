...
// Crea NUM FAC: Teniendo instalada la contribución del NIF aplicar esta query:
      //NIF start
    ...
    function cart() {
      ...
      // added by solomono:
      if(empty($tax_address['entry_country_id'])) {
        $tax_address = array('entry_country_id' => 195,
                             'entry_zone_id' => 161);
      }
...
// EOF Separate Pricing Per Customer attribute_groups mod
        ...
        if( is_object( $this->coupon ) ) {
          ...
          $shown_price = $this->coupon->calculate_shown_price('0', $this->products[$index] );
